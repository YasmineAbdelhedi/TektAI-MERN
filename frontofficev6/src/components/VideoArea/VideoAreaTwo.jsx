          ...
          <div className="col-lg-6">
            <div className="video-content">
              <div className="section-title mb-50">
                ...
                <h2 className="title">
                Your Success Drives Us: Your Achievements Are Our First{" "}
                  <span>
                    Priority
                    <svg
                      viewBox="0 0 173 24"
              ...
              <p>
              We believe that our platform's success is measured by the accomplishments of our users.
               From collaborating on industry challenges to crafting innovative solutions, 
               every achievement you make is at the forefront of our mission.
                Our dedication to fostering your success drives every aspect of our platform, 
                ensuring that you have the tools, support, and resources needed to thrive.
                 At TektAI, your triumphs fuel our passion for excellence, 
              inspiring us to continually elevate your journey towards success.
              </p>
