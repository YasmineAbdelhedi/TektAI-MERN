...
import BestServiceItem from "../BestServiceItem/BestServiceItem";
...
const ServicesArea = () => {
  ...
  return (
    <section className="services-area has-animation">
        ...
        <div className="row justify-content-center">
          <div className="col-xl-6 col-lg-6">
            <div className="section-title text-center mb-75">
              ...
              <h2 className="title">
                Providing the Best Services for Our{" "}
                <span>
                  Customers
                  <svg
                    viewBox="0 0 173 24"
